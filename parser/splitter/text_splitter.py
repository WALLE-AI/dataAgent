...
from entities.document import BaseDocumentTransformer, Document
...
def _split_text_with_regex(text: str, separator: str, keep_separator: bool) -> list[str]:
    # Now that we have the separator, splitter the text
    if separator:
        if keep_separator:
...
class CharacterTextSplitter(TextSplitter):
    ...
    def split_text(self, text: str) -> list[str]:
        ...
        # First we naively splitter the large input into a bunch of smaller ones.
...
class MarkdownHeaderTextSplitter:
    ...
    def __init__(self, headers_to_split_on: list[tuple[str, str]], return_each_line: bool = False):
        ...
        # Given the headers we want to splitter on,
    ...
    def split_text(self, text: str) -> list[Document]:
        ...
        for line in lines:
            ...
            for sep, name in self.headers_to_split_on:
                # Check if line starts with a header that we intend to splitter on
...
class RecursiveCharacterTextSplitter(TextSplitter):
    ...
    Recursively tries to splitter by different characters to find one
    that works.
    """
