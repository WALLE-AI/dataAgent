...
from parser.vision.utils.constants import LOGDIR
...
def find_all_linear_names(model):
    ...
    for name, module in model.named_modules():
        if isinstance(module,
                      cls) and 'vision_model' not in name and 'mm_projector' not in name and 'vision_encoder' not in name and 'conv_final' not in name and 'lm_head' not in name:
